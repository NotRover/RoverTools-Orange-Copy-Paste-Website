...
1. Download the installer from the [latest release](https://github.com/NotRover/RoverTools-Orange-Copy-Paste-App/releases/latest).
...
Builds ship as `.deb`, `.rpm` and AppImage from the same [releases page](https://github.com/NotRover/RoverTools-Orange-Copy-Paste-App/releases/latest).
