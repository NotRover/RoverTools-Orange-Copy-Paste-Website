...
Each release ships human-written notes sorted into **New**, **Improved** and **Fixed**. They show in the update banner, in Settings, and on the [releases page](https://github.com/NotRover/RoverTools-Orange-Copy-Paste-App/releases), which is also where all installers are published.
