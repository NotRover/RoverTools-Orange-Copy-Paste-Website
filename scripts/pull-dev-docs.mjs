...
const DOCS = [
	...
	{
		src: 'orange-copy-paste-clipboard-app-rust/docs/BUGFIX_HISTORY.md',
		out: 'bugfix-history',
		title: 'Bug fix history',
		description: 'Notable regressions and their root causes. Mirrored from the client repo.',
		repo: 'client',
		blob: RUST_BLOB + 'orange-copy-paste-clipboard-app-rust/docs/BUGFIX_HISTORY.md',
		raw: RUST_RAW + 'orange-copy-paste-clipboard-app-rust/docs/BUGFIX_HISTORY.md',
	},
	{
